...
class _AdvancePageState extends State<AdvancePage> {
  // Tambahkan variabel-variabel yang dibutuhkan di sini
  ...
  Future<void> _selectImageFromGallery() async {
      ...
      MaterialPageRoute(
        builder: (context) => GalleryPage(
          onSelectImage: (selectedFileName) {
            // Update controller di AdvancePage
            setState(() {
    ...
    // Handle further actions if needed after the user selects a file in GalleryPage
